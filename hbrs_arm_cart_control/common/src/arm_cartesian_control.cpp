...
/*void Arm_Cartesian_Control::checkForSingularity() {
	// calc Jacobian
        KDL::ChainJntToJacSolver jnt2Jac = new KDL::ChainJntToJacSolver(arm_chain);
	KDL::Jacobian jacobian(arm_chain.getNrOfJoints());
...
bool Arm_Cartesian_Control::isJointLimitsReached() {
        return jointLimitsReached;
