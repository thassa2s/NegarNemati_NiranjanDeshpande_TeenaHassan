...
-- rostopic pub /simple_arm_cartesian_trajectory_control/cartesian_trajectory_control_goal_posiition geometry_msgs/PoseStamd '{header: {frame_id: /base_link}, pose: {position: {x: 1, y: 2, z: 3}}}' 
