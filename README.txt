...
-- rostopic pub /simple_arm_cartesian_trajectory_control/cartesian_trajectory_control_goal_position geometry_msgs/PoseStamped '{header: {frame_id: /base_link}, pose: {position: {x: 0.275, y: 0.000, z: 0.1}}}'
